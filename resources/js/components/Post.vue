    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group" v-bind:class='[ errors.hasOwnProperty("content") ? "has-error" : "" ]'>
                ...
                <span v-if='[errors.hasOwnProperty("content")]' class="help-block"
                      v-for="error in errors.content">{{ error }}</span>
            </div>
        </div>
        <div class="panel-footer">
            <button class="btn btn-info pull-right" @click="post"><span class="glyphicon glyphicon-share"></span> Share
            </button>
